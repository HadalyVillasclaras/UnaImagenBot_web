  ...
  getDictionary() {
    return {
      en: {
        ...
        'intro-3': 'Una Imagen Bot operates as an exercise in counter-imagination, opening space for thinking new ways of representing the real beyond dominant visual models.',
      ...
      es: {
        ...
        'intro-3': 'Una Imagen Bot es un ejercicio de contra-imaginación que invita a imaginar nuevas representaciones posibles de lo real frente a los modelos de representación dominantes.',
